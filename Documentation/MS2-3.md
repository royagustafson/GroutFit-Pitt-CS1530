...
Log Out: Users will have the option to log out, after which they will only be able to see webapp data
...
Create Outfit: Uses will be able to create an initially empty outfit, or clone an outfit from a webapp feed.
...
Remove Outfit: Users will be able to delete any outfit of their own. They will be able to do so from the mannequin page, the webapp outfit feed, and their personal outfit feed.
